  ...
  blockchains: {
    ethereum: {
      ...
      midas: [
        ...
        '0xb64c014307622eb15046c66ff71d04258f5963dc', // Midas mevBTC Vault
      ],
      upshift: [
      ...
      mizu: [
        '0x416ec6e04c009f9bae99a47ef836bf2cc64ec93c', // Hype ETH Deposit Vault
        '0xd6fd5d4fa64fc7131e0ec3a4a53dc620a0ffc1bc', // Hype USD Deposit Vault
        '0x164645fbc7220a3b4f8f5c6b473bcf1b6db146dd', // Hype BTC Deposit Vault
      ],
      term: [
    ...
    plume: {
      morpho: [
        '0x0b14d0bdaf647c541d3887c5b1a4bd64068fcda7', // Mystic MEV Capital
      ]
    },
    solana: {
      kamino: [
        '0xqaytekciq4gc42k683rtawu3jxqcea7jkekzxwwuwbo', // MEV Capital SOL
        '0xepc2n3aav84p9tksndt2x41p6t7c5vtewbhqbh4rvx4r', // MEV CAPITAL USDC Prime
      ]
    },
    berachain: {
      euler: [
    ...
    hyperevm: {
      hyperbeat: [
        ...
        '0x441794d6a8f9a3739f5d4e98a728937b33489d29', // Hyperbeat beHYPE
        '0x81e064d0eb539de7c3170edf38c1a42cbd752a76', // Hyperbeat lstHYPE
        '0xd3a9cb7312b9c29113290758f5adfe12304cd16a', // Hyperbeat USR
        '0x6eb6724d8d3d4ff9e24d872e8c38403169dc05f8', // Hyperbeat XAUt
      ]
    },
    sonic: {
      euler: [
